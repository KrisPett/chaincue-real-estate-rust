        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(ColumnDef::new(HouseImages::Id).string_len(255).not_null().primary_key())
                    ...
                    .col(ColumnDef::new(HouseImages::Url).string_len(255).not_null())
                    .col(ColumnDef::new(HouseImages::HouseId).string_len(255).not_null())
